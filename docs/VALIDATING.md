...
Use `uv run --locked just ...` to select the project's locked just executable.
...
for a clean PyPI installation and bootstrap check before closing the release issue.
